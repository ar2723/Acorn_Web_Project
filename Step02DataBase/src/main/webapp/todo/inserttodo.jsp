...
<body>
	<div class="container">
		...
		<form action="insert.jsp" method ="get">
			...
			<div class="mb-1">
			<label for="list" class="form-label">할일</label>
			<input type="text" name ="list" class="form-control" id ="list"/>
			</div>
			<div class="mb-1">
			<label for="impo" class="form-label">중요도</label>
			<input type="text" name ="impo" class="form-control" id ="impo"/>
			</div>
			<div class="mb-1">
			<label for="due" class="form-label">마감기간</label>
