		...
		<table class="table table-striped table-hover">
			...
			<tbody class="text-center">
				...
				<tr>
					<td><%= tmp.getNum()%></td>
					<td><%= tmp.getWriter()%></td>
					<td id="listContent"><textarea class="form-control" rows="5"
							readonly><%= tmp.getContent()%></textarea></td>
					<td><%= tmp.getDate()%></td>
					<td>
						<a
							href="${pageContext.request.contextPath}/guest/updateform.jsp?num=<%=tmp.getNum()%>">
