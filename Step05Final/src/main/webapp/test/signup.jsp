...
<%
	...
	/*
		textarea에 입력한 문자열은 개행, tab, 공백기호가 모두 포함되어 있다.
		...
		<form action="signup.jsp" method="post">
                  ...
                  <fieldset>
                        ...
                        <div class="form-check form-switch">
                              <input class="form-check-input" type="checkbox"  id="allowAll" <%= allowEmail !=null && allowMessage !=null ? "checked":"" %>>
